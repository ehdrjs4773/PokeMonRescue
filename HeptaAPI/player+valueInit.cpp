...
{	
	_idleCount = _moveCount = _attackCount = _S_AttackCount = _S_AttackCount_2 = _S_AttackCount_3 = 
		_S_AttackCount_4 =_hurtCount = _dieCount = 0;
	_idleFrameX = _moveFrameX = _attackFrameX = _S_AttackFrameX = _S_AttackFrameX_2 = _S_AttackFrameX_3 
		= _S_AttackFrameX_4 = _hurtFrameX = _dieFrameX = 0;
