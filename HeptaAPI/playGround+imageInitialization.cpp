...
void playGround::imageInitaialization(void)
{
	...
	EFFECTMANAGER->addEffect("불_0", ".\\bmps\\skill\\불대문자.bmp", 1560, 52, 60, 52, 1.0f, 0.5f, 1);
	EFFECTMANAGER->addEffect("불_1", ".\\bmps\\skill\\overhite.bmp", 384, 32, 32, 32, 1.0f, 1.0f, 1);
	EFFECTMANAGER->addEffect("불_2", ".\\bmps\\skill\\test.bmp", 4466, 140, 154, 140, 1.0f, 0.5f, 1);
