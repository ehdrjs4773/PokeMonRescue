...
void playGround::imageInitaialization(void)
{
	...
	EFFECTMANAGER->addEffect("fireMeteo", ".\\bmps\\skill\\test.bmp", 4466, 140, 154, 140, 1.0f, 0.5f, 1);
	EFFECTMANAGER->addEffect("iceShot", ".\\bmps\\skill\\iceshot.bmp", 320, 48, 32, 48, 1.0f, 1.0f, 1);
	EFFECTMANAGER->addEffect("overhite", ".\\bmps\\skill\\overhite.bmp", 384, 32, 32, 32, 1.0f, 1.0f, 1);
